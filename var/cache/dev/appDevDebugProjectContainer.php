...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jcE3Z980jC', 0, 'DSUlnF97Yuhe1vB9-YPA7w', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yI6AlT0I-R', 0, 'DSUlnF97Yuhe1vB9-YPA7w', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('E-lP8KGXpO', 0, 'DSUlnF97Yuhe1vB9-YPA7w', (__DIR__.'/pools'), $a));
    ...
    public function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['doctrine.orm.default_entity_manager'] = new DoctrineORMEntityManager_0000000022a549a1000000000f55590d9139e133ec8e531f59284f4ef1e039c0(
...
class DoctrineORMEntityManager_0000000022a549a1000000000f55590d9139e133ec8e531f59284f4ef1e039c0 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder57eba7866bf90502063172 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer57eba7866bfa5739140330 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties57eba7866bf5e126845070 = array(
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'getConnection', array(), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->getConnection();
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'getMetadataFactory', array(), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->getMetadataFactory();
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'getExpressionBuilder', array(), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->getExpressionBuilder();
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'beginTransaction', array(), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->beginTransaction();
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'getCache', array(), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->getCache();
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'transactional', array('func' => $func), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->transactional($func);
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'commit', array(), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->commit();
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'rollback', array(), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->rollback();
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'getClassMetadata', array('className' => $className), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->getClassMetadata($className);
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'createQuery', array('dql' => $dql), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->createQuery($dql);
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'createNamedQuery', array('name' => $name), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->createNamedQuery($name);
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->createNativeQuery($sql, $rsm);
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->createNamedNativeQuery($name);
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'createQueryBuilder', array(), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->createQueryBuilder();
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'flush', array('entity' => $entity), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->flush($entity);
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'find', array('entityName' => $entityName, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->find($entityName, $id, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->getReference($entityName, $id);
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->getPartialReference($entityName, $identifier);
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'clear', array('entityName' => $entityName), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->clear($entityName);
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'close', array(), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->close();
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'persist', array('entity' => $entity), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->persist($entity);
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'remove', array('entity' => $entity), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->remove($entity);
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'refresh', array('entity' => $entity), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->refresh($entity);
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'detach', array('entity' => $entity), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->detach($entity);
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'merge', array('entity' => $entity), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->merge($entity);
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->copy($entity, $deep);
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->lock($entity, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'getRepository', array('entityName' => $entityName), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->getRepository($entityName);
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'contains', array('entity' => $entity), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->contains($entity);
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'getEventManager', array(), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->getEventManager();
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'getConfiguration', array(), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->getConfiguration();
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'isOpen', array(), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->isOpen();
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'getUnitOfWork', array(), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->getUnitOfWork();
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->getHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->newHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'getProxyFactory', array(), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->getProxyFactory();
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'initializeObject', array('obj' => $obj), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->initializeObject($obj);
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'getFilters', array(), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->getFilters();
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'isFiltersStateClean', array(), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->isFiltersStateClean();
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'hasFilters', array(), $this->initializer57eba7866bfa5739140330);

        return $this->valueHolder57eba7866bf90502063172->hasFilters();
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 = $initializer;
    }
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, '__get', array('name' => $name), $this->initializer57eba7866bfa5739140330);

        if (isset(self::$publicProperties57eba7866bf5e126845070[$name])) {
            return $this->valueHolder57eba7866bf90502063172->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder57eba7866bf90502063172;
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer57eba7866bfa5739140330);
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, '__isset', array('name' => $name), $this->initializer57eba7866bfa5739140330);
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, '__unset', array('name' => $name), $this->initializer57eba7866bfa5739140330);
    ...
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, '__clone', array(), $this->initializer57eba7866bfa5739140330);

        $this->valueHolder57eba7866bf90502063172 = clone $this->valueHolder57eba7866bf90502063172;
    }

    public function __sleep()
    {
        $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, '__sleep', array(), $this->initializer57eba7866bfa5739140330);

        return array('valueHolder57eba7866bf90502063172');
    }
    ...
    {
        return $this->initializer57eba7866bfa5739140330;
    }
    ...
    {
        return $this->initializer57eba7866bfa5739140330 && $this->initializer57eba7866bfa5739140330->__invoke($this->valueHolder57eba7866bf90502063172, $this, 'initializeProxy', array(), $this->initializer57eba7866bfa5739140330);
    }
    ...
    {
        return null !== $this->valueHolder57eba7866bf90502063172;
    }
    ...
    {
        return $this->valueHolder57eba7866bf90502063172;
    }
