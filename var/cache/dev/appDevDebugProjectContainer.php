...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('93bQzq1Xt0', 0, 'yq39tHTkOmlxI2YuYtcPXg', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('P2GU4gPcIb', 0, 'yq39tHTkOmlxI2YuYtcPXg', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('EccDeXiE0b', 0, 'yq39tHTkOmlxI2YuYtcPXg', (__DIR__.'/pools'), $a));
    ...
    public function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['doctrine.orm.default_entity_manager'] = new DoctrineORMEntityManager_000000005bd07095000000007cf3c2b1cc280913f16c6ab8ac3b2de48c80cb5f(
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'lgp.admin.prof', 1 => 'lgp.admin.parent', 2 => 'lgp.admin.remuneration', 3 => 'lgp.admin.quartier_cible', 4 => 'lgp.admin.categorie_cours', 5 => 'lgp.admin.cours'));
        $instance->setAdminGroups(array('lgp_admin.group.user' => array('label' => 'Utilisateurs', 'items' => array(0 => array('admin' => 'lgp.admin.prof', 'label' => '', 'route' => '', 'route_params' => array(), 'route_absolute' => true), 1 => array('admin' => 'lgp.admin.parent', 'label' => '', 'route' => '', 'route_params' => array(), 'route_absolute' => true), 2 => array('admin' => 'lgp.admin.quartier_cible', 'label' => '', 'route' => '', 'route_params' => array(), 'route_absolute' => true)), 'icon' => '<i class="fa fa-folder"></i>', 'on_top' => false, 'item_adds' => array(), 'roles' => array(), 'label_catalogue' => 'SonataAdminBundle'), 'lgp_admin.group.cours' => array('label' => 'Cours', 'items' => array(0 => array('admin' => 'lgp.admin.categorie_cours', 'label' => '', 'route' => '', 'route_params' => array(), 'route_absolute' => true), 1 => array('admin' => 'lgp.admin.cours', 'label' => '', 'route' => '', 'route_params' => array(), 'route_absolute' => true)), 'icon' => '<i class="fa fa-folder"></i>', 'on_top' => false, 'item_adds' => array(), 'roles' => array(), 'label_catalogue' => 'SonataAdminBundle'), 'lgp_admin.group.reservation' => array('label' => 'Réservations', 'items' => array(0 => array('admin' => 'lgp.admin.remuneration', 'label' => '', 'route' => '', 'route_params' => array(), 'route_absolute' => true)), 'icon' => '<i class="fa fa-folder"></i>', 'on_top' => false, 'item_adds' => array(), 'roles' => array(), 'label_catalogue' => 'SonataAdminBundle')));
        $instance->setAdminClasses(array('LGP\\UserBundle\\Entity\\Prof' => array(0 => 'lgp.admin.prof'), 'LGP\\UserBundle\\Entity\\Parents' => array(0 => 'lgp.admin.parent'), 'LGP\\UserBundle\\Entity\\Remuneration' => array(0 => 'lgp.admin.remuneration'), 'LGP\\UserBundle\\Entity\\Quartier' => array(0 => 'lgp.admin.quartier_cible'), 'LGP\\CourseBundle\\Entity\\Categorie' => array(0 => 'lgp.admin.categorie_cours'), 'LGP\\CourseBundle\\Entity\\Cours' => array(0 => 'lgp.admin.cours')));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'lgp.admin.prof', 1 => 'lgp.admin.parent', 2 => 'lgp.admin.remuneration', 3 => 'lgp.admin.quartier_cible', 4 => 'lgp.admin.categorie_cours', 5 => 'lgp.admin.cours'), $this);
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('info@unadresse.com');
        $a->setPassword('pwdinf2015');
        $a->setAuthMode(NULL);

        $this->services['swiftmailer.mailer.default.transport.real'] = $instance = new \Swift_Transport_EsmtpTransport(new \Swift_Transport_StreamBuffer(new \Swift_StreamFilters_StringReplacementFilterFactory()), array(0 => $a), $this->get('swiftmailer.mailer.default.transport.eventdispatcher'));

        $instance->setHost('smtp.unadresse.com');
        $instance->setPort(25);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_host' => 'smtp.unadresse.com',
            'mailer_user' => 'info@unadresse.com',
            'mailer_password' => 'pwdinf2015',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'smtp.unadresse.com',
            'swiftmailer.mailer.default.transport.smtp.username' => 'info@unadresse.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'pwdinf2015',
...
class DoctrineORMEntityManager_000000005bd07095000000007cf3c2b1cc280913f16c6ab8ac3b2de48c80cb5f extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder57edcda789445087196352 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer57edcda78949f325845593 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties57edcda78938a488680077 = array(
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'getConnection', array(), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->getConnection();
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'getMetadataFactory', array(), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->getMetadataFactory();
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'getExpressionBuilder', array(), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->getExpressionBuilder();
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'beginTransaction', array(), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->beginTransaction();
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'getCache', array(), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->getCache();
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'transactional', array('func' => $func), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->transactional($func);
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'commit', array(), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->commit();
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'rollback', array(), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->rollback();
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'getClassMetadata', array('className' => $className), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->getClassMetadata($className);
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'createQuery', array('dql' => $dql), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->createQuery($dql);
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'createNamedQuery', array('name' => $name), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->createNamedQuery($name);
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->createNativeQuery($sql, $rsm);
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->createNamedNativeQuery($name);
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'createQueryBuilder', array(), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->createQueryBuilder();
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'flush', array('entity' => $entity), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->flush($entity);
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'find', array('entityName' => $entityName, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->find($entityName, $id, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->getReference($entityName, $id);
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->getPartialReference($entityName, $identifier);
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'clear', array('entityName' => $entityName), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->clear($entityName);
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'close', array(), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->close();
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'persist', array('entity' => $entity), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->persist($entity);
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'remove', array('entity' => $entity), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->remove($entity);
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'refresh', array('entity' => $entity), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->refresh($entity);
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'detach', array('entity' => $entity), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->detach($entity);
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'merge', array('entity' => $entity), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->merge($entity);
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->copy($entity, $deep);
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->lock($entity, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'getRepository', array('entityName' => $entityName), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->getRepository($entityName);
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'contains', array('entity' => $entity), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->contains($entity);
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'getEventManager', array(), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->getEventManager();
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'getConfiguration', array(), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->getConfiguration();
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'isOpen', array(), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->isOpen();
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'getUnitOfWork', array(), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->getUnitOfWork();
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->getHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->newHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'getProxyFactory', array(), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->getProxyFactory();
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'initializeObject', array('obj' => $obj), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->initializeObject($obj);
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'getFilters', array(), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->getFilters();
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'isFiltersStateClean', array(), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->isFiltersStateClean();
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'hasFilters', array(), $this->initializer57edcda78949f325845593);

        return $this->valueHolder57edcda789445087196352->hasFilters();
    }
    ...
    {
        $this->initializer57edcda78949f325845593 = $initializer;
    }
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, '__get', array('name' => $name), $this->initializer57edcda78949f325845593);

        if (isset(self::$publicProperties57edcda78938a488680077[$name])) {
            return $this->valueHolder57edcda789445087196352->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder57edcda789445087196352;
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer57edcda78949f325845593);
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, '__isset', array('name' => $name), $this->initializer57edcda78949f325845593);
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, '__unset', array('name' => $name), $this->initializer57edcda78949f325845593);
    ...
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, '__clone', array(), $this->initializer57edcda78949f325845593);

        $this->valueHolder57edcda789445087196352 = clone $this->valueHolder57edcda789445087196352;
    }

    public function __sleep()
    {
        $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, '__sleep', array(), $this->initializer57edcda78949f325845593);

        return array('valueHolder57edcda789445087196352');
    }
    ...
    {
        return $this->initializer57edcda78949f325845593;
    }
    ...
    {
        return $this->initializer57edcda78949f325845593 && $this->initializer57edcda78949f325845593->__invoke($this->valueHolder57edcda789445087196352, $this, 'initializeProxy', array(), $this->initializer57edcda78949f325845593);
    }
    ...
    {
        return null !== $this->valueHolder57edcda789445087196352;
    }
    ...
    {
        return $this->valueHolder57edcda789445087196352;
    }
