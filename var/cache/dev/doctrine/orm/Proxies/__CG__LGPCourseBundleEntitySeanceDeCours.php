...
class SeanceDeCours extends \LGP\CourseBundle\Entity\SeanceDeCours implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'LGP\\CourseBundle\\Entity\\SeanceDeCours' . "\0" . 'id', '' . "\0" . 'LGP\\CourseBundle\\Entity\\SeanceDeCours' . "\0" . 'resume', '' . "\0" . 'LGP\\CourseBundle\\Entity\\SeanceDeCours' . "\0" . 'date', '' . "\0" . 'LGP\\CourseBundle\\Entity\\SeanceDeCours' . "\0" . 'nbHeures', '' . "\0" . 'LGP\\CourseBundle\\Entity\\SeanceDeCours' . "\0" . 'jourDeCours', '' . "\0" . 'LGP\\CourseBundle\\Entity\\SeanceDeCours' . "\0" . 'prof'];
        }
