 ...
 */
class ImageCategorie extends \LGP\CourseBundle\Entity\ImageCategorie implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'LGP\\CourseBundle\\Entity\\ImageCategorie' . "\0" . 'id', '' . "\0" . 'LGP\\CourseBundle\\Entity\\ImageCategorie' . "\0" . 'updatedAt', '' . "\0" . 'LGP\\CourseBundle\\Entity\\ImageCategorie' . "\0" . 'imageName', '' . "\0" . 'LGP\\CourseBundle\\Entity\\ImageCategorie' . "\0" . 'imageFile'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ImageCategorie $proxy) {
