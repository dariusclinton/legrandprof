...
class ReservationEnseignement extends \LGP\ReservationBundle\Entity\ReservationEnseignement implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'LGP\\ReservationBundle\\Entity\\ReservationEnseignement' . "\0" . 'id', '' . "\0" . 'LGP\\ReservationBundle\\Entity\\ReservationEnseignement' . "\0" . 'lieuDeCours', '' . "\0" . 'LGP\\ReservationBundle\\Entity\\ReservationEnseignement' . "\0" . 'dateDebut', '' . "\0" . 'LGP\\ReservationBundle\\Entity\\ReservationEnseignement' . "\0" . 'dateFin', '' . "\0" . 'LGP\\ReservationBundle\\Entity\\ReservationEnseignement' . "\0" . 'nbApprenants', '' . "\0" . 'LGP\\ReservationBundle\\Entity\\ReservationEnseignement' . "\0" . 'ville', '' . "\0" . 'LGP\\ReservationBundle\\Entity\\ReservationEnseignement' . "\0" . 'quartier', '' . "\0" . 'LGP\\ReservationBundle\\Entity\\ReservationEnseignement' . "\0" . 'joursDeCours', '' . "\0" . 'LGP\\ReservationBundle\\Entity\\ReservationEnseignement' . "\0" . 'reservation', '' . "\0" . 'LGP\\ReservationBundle\\Entity\\ReservationEnseignement' . "\0" . 'enseignement'];
        }
