 ...
 */
class ImageCourse extends \LGP\CourseBundle\Entity\ImageCourse implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'LGP\\CourseBundle\\Entity\\ImageCourse' . "\0" . 'id', '' . "\0" . 'LGP\\CourseBundle\\Entity\\ImageCourse' . "\0" . 'updatedAt', '' . "\0" . 'LGP\\CourseBundle\\Entity\\ImageCourse' . "\0" . 'imageName', '' . "\0" . 'LGP\\CourseBundle\\Entity\\ImageCourse' . "\0" . 'imageFile'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ImageCourse $proxy) {
