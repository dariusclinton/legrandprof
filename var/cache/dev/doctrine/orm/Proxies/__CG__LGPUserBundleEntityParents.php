 ...
 */
class Parents extends \LGP\UserBundle\Entity\Parents implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'LGP\\UserBundle\\Entity\\Parents' . "\0" . 'id', '' . "\0" . 'LGP\\UserBundle\\Entity\\Parents' . "\0" . 'user', '' . "\0" . 'LGP\\UserBundle\\Entity\\Parents' . "\0" . 'reservations', '' . "\0" . 'LGP\\UserBundle\\Entity\\Parents' . "\0" . 'paiements'];
        }
