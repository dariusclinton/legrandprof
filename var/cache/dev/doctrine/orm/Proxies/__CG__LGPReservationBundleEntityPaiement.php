 ...
 */
class Paiement extends \LGP\ReservationBundle\Entity\Paiement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'LGP\\ReservationBundle\\Entity\\Paiement' . "\0" . 'id', '' . "\0" . 'LGP\\ReservationBundle\\Entity\\Paiement' . "\0" . 'mode', '' . "\0" . 'LGP\\ReservationBundle\\Entity\\Paiement' . "\0" . 'date', '' . "\0" . 'LGP\\ReservationBundle\\Entity\\Paiement' . "\0" . 'facture', '' . "\0" . 'LGP\\ReservationBundle\\Entity\\Paiement' . "\0" . 'user'];
        }
