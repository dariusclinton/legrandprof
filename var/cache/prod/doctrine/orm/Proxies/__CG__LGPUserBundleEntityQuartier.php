...
class Quartier extends \LGP\UserBundle\Entity\Quartier implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'LGP\\UserBundle\\Entity\\Quartier' . "\0" . 'id', '' . "\0" . 'LGP\\UserBundle\\Entity\\Quartier' . "\0" . 'intitule', '' . "\0" . 'LGP\\UserBundle\\Entity\\Quartier' . "\0" . 'ville', '' . "\0" . 'LGP\\UserBundle\\Entity\\Quartier' . "\0" . 'profs'];
        }
