 ...
 */
class Evaluation extends \LGP\CourseBundle\Entity\Evaluation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'LGP\\CourseBundle\\Entity\\Evaluation' . "\0" . 'id', '' . "\0" . 'LGP\\CourseBundle\\Entity\\Evaluation' . "\0" . 'date', '' . "\0" . 'LGP\\CourseBundle\\Entity\\Evaluation' . "\0" . 'duree', '' . "\0" . 'LGP\\CourseBundle\\Entity\\Evaluation' . "\0" . 'reservationEnseignement', '' . "\0" . 'LGP\\CourseBundle\\Entity\\Evaluation' . "\0" . 'prof'];
        }
