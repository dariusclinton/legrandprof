...
class Avis extends \LGP\UserBundle\Entity\Avis implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'LGP\\UserBundle\\Entity\\Avis' . "\0" . 'user', '' . "\0" . 'LGP\\UserBundle\\Entity\\Avis' . "\0" . 'prof', '' . "\0" . 'LGP\\UserBundle\\Entity\\Avis' . "\0" . 'id', '' . "\0" . 'LGP\\UserBundle\\Entity\\Avis' . "\0" . 'note', '' . "\0" . 'LGP\\UserBundle\\Entity\\Avis' . "\0" . 'commentaire', '' . "\0" . 'LGP\\UserBundle\\Entity\\Avis' . "\0" . 'isRead', '' . "\0" . 'LGP\\UserBundle\\Entity\\Avis' . "\0" . 'dateAvis'];
        }
