 ...
 */
class Chapitre extends \LGP\CourseBundle\Entity\Chapitre implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'LGP\\CourseBundle\\Entity\\Chapitre' . "\0" . 'id', '' . "\0" . 'LGP\\CourseBundle\\Entity\\Chapitre' . "\0" . 'numeroDePartie', '' . "\0" . 'LGP\\CourseBundle\\Entity\\Chapitre' . "\0" . 'intitule', '' . "\0" . 'LGP\\CourseBundle\\Entity\\Chapitre' . "\0" . 'programme'];
        }
    ...
    public function setNumeroDePartie($numeroDePartie)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNumeroDePartie', [$numeroDePartie]);

        return parent::setNumeroDePartie($numeroDePartie);
    }
    ...
    public function getNumeroDePartie()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNumeroDePartie', []);

        return parent::getNumeroDePartie();
    }
