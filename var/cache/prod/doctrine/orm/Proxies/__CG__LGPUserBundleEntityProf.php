...
class Prof extends \LGP\UserBundle\Entity\Prof implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'LGP\\UserBundle\\Entity\\Prof' . "\0" . 'ville', '' . "\0" . 'LGP\\UserBundle\\Entity\\Prof' . "\0" . 'quartierCibles', '' . "\0" . 'LGP\\UserBundle\\Entity\\Prof' . "\0" . 'boitePostale', '' . "\0" . 'LGP\\UserBundle\\Entity\\Prof' . "\0" . 'situationMatrimoniale', '' . "\0" . 'LGP\\UserBundle\\Entity\\Prof' . "\0" . 'niveauScolaire', '' . "\0" . 'LGP\\UserBundle\\Entity\\Prof' . "\0" . 'nombreEnfants', '' . "\0" . 'LGP\\UserBundle\\Entity\\Prof' . "\0" . 'isRecommande', '' . "\0" . 'LGP\\UserBundle\\Entity\\Prof' . "\0" . 'presentation', '' . "\0" . 'LGP\\UserBundle\\Entity\\Prof' . "\0" . 'profession', '' . "\0" . 'LGP\\UserBundle\\Entity\\Prof' . "\0" . 'CVFile', '' . "\0" . 'LGP\\UserBundle\\Entity\\Prof' . "\0" . 'seancesDeCours', '' . "\0" . 'LGP\\UserBundle\\Entity\\Prof' . "\0" . 'enseignements', '' . "\0" . 'LGP\\UserBundle\\Entity\\Prof' . "\0" . 'evaluations', '' . "\0" . 'LGP\\UserBundle\\Entity\\Prof' . "\0" . 'diplomes', '' . "\0" . 'LGP\\UserBundle\\Entity\\Prof' . "\0" . 'experiencePros', '' . "\0" . 'LGP\\UserBundle\\Entity\\Prof' . "\0" . 'remunerations', '' . "\0" . 'LGP\\UserBundle\\Entity\\Prof' . "\0" . 'slug', 'image', 'nom', 'prenoms', 'dateNaissance', 'sexe', 'telephone', 'pays', 'dateInscription', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt'];
        }
    ...
    public function addQuartierCible(\LGP\UserBundle\Entity\Quartier $quartierCible)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addQuartierCible', [$quartierCible]);

        return parent::addQuartierCible($quartierCible);
    }
    ...
    public function removeQuartierCible(\LGP\UserBundle\Entity\Quartier $quartierCible)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeQuartierCible', [$quartierCible]);

        return parent::removeQuartierCible($quartierCible);
    }
    ...
    public function getQuartierCibles()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getQuartierCibles', []);

        return parent::getQuartierCibles();
    }
    ...
    public function addRemuneration(\LGP\UserBundle\Entity\Remuneration $remuneration)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addRemuneration', [$remuneration]);

        return parent::addRemuneration($remuneration);
    }
    ...
    public function removeRemuneration(\LGP\UserBundle\Entity\Remuneration $remuneration)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeRemuneration', [$remuneration]);

        return parent::removeRemuneration($remuneration);
    }
    ...
    public function getRemunerations()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRemunerations', []);

        return parent::getRemunerations();
    }
