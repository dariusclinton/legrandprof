...
class Diplome extends \LGP\UserBundle\Entity\Diplome implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'LGP\\UserBundle\\Entity\\Diplome' . "\0" . 'id', '' . "\0" . 'LGP\\UserBundle\\Entity\\Diplome' . "\0" . 'intitule', '' . "\0" . 'LGP\\UserBundle\\Entity\\Diplome' . "\0" . 'specialite', '' . "\0" . 'LGP\\UserBundle\\Entity\\Diplome' . "\0" . 'annee'];
        }
