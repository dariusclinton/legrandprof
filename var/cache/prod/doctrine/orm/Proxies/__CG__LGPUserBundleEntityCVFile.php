 ...
 */
class CVFile extends \LGP\UserBundle\Entity\CVFile implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'LGP\\UserBundle\\Entity\\CVFile' . "\0" . 'id', '' . "\0" . 'LGP\\UserBundle\\Entity\\CVFile' . "\0" . 'updatedAt', '' . "\0" . 'LGP\\UserBundle\\Entity\\CVFile' . "\0" . 'file', '' . "\0" . 'LGP\\UserBundle\\Entity\\CVFile' . "\0" . 'fileName'];
        }
