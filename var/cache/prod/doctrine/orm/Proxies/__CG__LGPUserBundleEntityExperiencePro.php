 ...
 */
class ExperiencePro extends \LGP\UserBundle\Entity\ExperiencePro implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'LGP\\UserBundle\\Entity\\ExperiencePro' . "\0" . 'prof', '' . "\0" . 'LGP\\UserBundle\\Entity\\ExperiencePro' . "\0" . 'id', '' . "\0" . 'LGP\\UserBundle\\Entity\\ExperiencePro' . "\0" . 'etablissement', '' . "\0" . 'LGP\\UserBundle\\Entity\\ExperiencePro' . "\0" . 'poste', '' . "\0" . 'LGP\\UserBundle\\Entity\\ExperiencePro' . "\0" . 'dateDebut', '' . "\0" . 'LGP\\UserBundle\\Entity\\ExperiencePro' . "\0" . 'dateFin', '' . "\0" . 'LGP\\UserBundle\\Entity\\ExperiencePro' . "\0" . 'description'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ExperiencePro $proxy) {
     ...
     * {@inheritDoc}
     */
    public function isDateFinValid(\Symfony\Component\Validator\Context\ExecutionContextInterface $context)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isDateFinValid', [$context]);

        return parent::isDateFinValid($context);
    }
