 ...
 */
class Facture extends \LGP\ReservationBundle\Entity\Facture implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'LGP\\ReservationBundle\\Entity\\Facture' . "\0" . 'id', '' . "\0" . 'LGP\\ReservationBundle\\Entity\\Facture' . "\0" . 'montant', '' . "\0" . 'LGP\\ReservationBundle\\Entity\\Facture' . "\0" . 'reservations', '' . "\0" . 'LGP\\ReservationBundle\\Entity\\Facture' . "\0" . 'paiement'];
        }
