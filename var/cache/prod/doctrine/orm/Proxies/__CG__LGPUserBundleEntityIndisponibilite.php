 ...
 */
class Indisponibilite extends \LGP\UserBundle\Entity\Indisponibilite implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'LGP\\UserBundle\\Entity\\Indisponibilite' . "\0" . 'prof', '' . "\0" . 'LGP\\UserBundle\\Entity\\Indisponibilite' . "\0" . 'id', '' . "\0" . 'LGP\\UserBundle\\Entity\\Indisponibilite' . "\0" . 'dateDebut', '' . "\0" . 'LGP\\UserBundle\\Entity\\Indisponibilite' . "\0" . 'dateFin', '' . "\0" . 'LGP\\UserBundle\\Entity\\Indisponibilite' . "\0" . 'motif'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Indisponibilite $proxy) {
