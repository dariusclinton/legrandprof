...
class Image extends \LGP\UserBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'LGP\\UserBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'LGP\\UserBundle\\Entity\\Image' . "\0" . 'updatedAt', '' . "\0" . 'LGP\\UserBundle\\Entity\\Image' . "\0" . 'imageFile', '' . "\0" . 'LGP\\UserBundle\\Entity\\Image' . "\0" . 'imageName'];
        }
