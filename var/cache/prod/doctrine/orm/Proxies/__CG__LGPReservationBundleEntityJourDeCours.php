 ...
 */
class JourDeCours extends \LGP\ReservationBundle\Entity\JourDeCours implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'LGP\\ReservationBundle\\Entity\\JourDeCours' . "\0" . 'id', '' . "\0" . 'LGP\\ReservationBundle\\Entity\\JourDeCours' . "\0" . 'intitule', '' . "\0" . 'LGP\\ReservationBundle\\Entity\\JourDeCours' . "\0" . 'reservationEnseignements', '' . "\0" . 'LGP\\ReservationBundle\\Entity\\JourDeCours' . "\0" . 'seanceDeCours'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (JourDeCours $proxy) {
    ...
    public function setSeanceDeCours(\LGP\CourseBundle\Entity\SeanceDeCours $seanceDeCours = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSeanceDeCours', [$seanceDeCours]);

        return parent::setSeanceDeCours($seanceDeCours);
    }
