 ...
 */
class Enseignement extends \LGP\CourseBundle\Entity\Enseignement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'LGP\\CourseBundle\\Entity\\Enseignement' . "\0" . 'id', '' . "\0" . 'LGP\\CourseBundle\\Entity\\Enseignement' . "\0" . 'classe', '' . "\0" . 'LGP\\CourseBundle\\Entity\\Enseignement' . "\0" . 'prix', '' . "\0" . 'LGP\\CourseBundle\\Entity\\Enseignement' . "\0" . 'cours', '' . "\0" . 'LGP\\CourseBundle\\Entity\\Enseignement' . "\0" . 'prof', '' . "\0" . 'LGP\\CourseBundle\\Entity\\Enseignement' . "\0" . 'reservationEnseignements'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Enseignement $proxy) {
