...
class __TwigTemplate_ad6f2a5dca046b0ca50d08e3d4845893f9674d55769c92bf7677c55363be4726 extends Twig_Template
{
        ...
        <div class=\"pager-innner\">
            ...
            if (($this->getAttribute($this->getAttribute((isset($context["params"]) ? $context["params"] : null), "pagination", array()), "page", array()) > 1)) {
                ...
                echo "                                <li>
                                    <a href=\"";
                // line 24
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath($this->getAttribute($this->getAttribute((isset($context["params"]) ? $context["params"] : null), "pagination", array()), "route", array()), twig_array_merge($this->getAttribute($this->getAttribute((isset($context["params"]) ? $context["params"] : null), "pagination", array()), "route_params", array()), array("page" => ($this->getAttribute($this->getAttribute(                // line 25
(isset($context["params"]) ? $context["params"] : null), "pagination", array()), "page", array()) - 1)))), "html", null, true);
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["p"]) {
                ...
                echo "> 
                                    <a href=\"";
                // line 34
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath($this->getAttribute($this->getAttribute((isset($context["params"]) ? $context["params"] : null), "pagination", array()), "route", array()), twig_array_merge($this->getAttribute($this->getAttribute((isset($context["params"]) ? $context["params"] : null), "pagination", array()), "route_params", array()), array("page" => $context["p"]))), "html", null, true);
                echo "\">";
            ...
            if (($this->getAttribute($this->getAttribute((isset($context["params"]) ? $context["params"] : null), "pagination", array()), "page", array()) < $this->getAttribute($this->getAttribute((isset($context["params"]) ? $context["params"] : null), "pagination", array()), "pages_count", array()))) {
                ...
                echo "                                <li>
                                    <a href=\"";
                // line 41
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath($this->getAttribute($this->getAttribute((isset($context["params"]) ? $context["params"] : null), "pagination", array()), "route", array()), twig_array_merge($this->getAttribute($this->getAttribute((isset($context["params"]) ? $context["params"] : null), "pagination", array()), "route_params", array()), array("page" => ($this->getAttribute($this->getAttribute(                // line 42
(isset($context["params"]) ? $context["params"] : null), "pagination", array()), "page", array()) + 1)))), "html", null, true);
...
";
    ...
    {
        return "{% if params.pagination.pages_count > 1 %}
