...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('LKz9m6zUhk', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DP8H88ipCp', 0, '-nWiDvWc2Iymt1-rNNaTuw', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $a->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TyqVrD8jZy', 0, '-nWiDvWc2Iymt1-rNNaTuw', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $e->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('user_image', $c, $a, $b));
        $e->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('cv_file', $c, $a, $b));
        $e->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('diplome_file', $c, $a, $b));
        $e->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('categorie_image', $c, $a, $b));
        $e->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('course_image', $c, $a, $b));
        $e->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('user_image', $c, $a, $b));
        $e->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('categorie_image', $c, $a, $b));
        $e->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('user_image', $c, $a, $b));
        $e->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('diplome_file', $c, $a, $b));
        $e->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('cv_file', $c, $a, $b));
        $e->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('diplome_file', $c, $a, $b));
        $e->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('course_image', $c, $a, $b));
        $e->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('categorie_image', $c, $a, $b));
        $e->addEventSubscriber(new \FOS\UserBundle\Doctrine\UserListener($this));
        $e->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('course_image', $c, $a, $b));
        $e->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('cv_file', $c, $a, $b));
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'legrandprof', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $e, array());
    }
    ...
    public function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['doctrine.orm.default_entity_manager'] = new DoctrineORMEntityManager_0000000036e295520000000070d20233192495198c3a374831398440c7902962(
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_315a82895d0afcb469530f6052bd425bb5f0b3afbfc2a010927cb7548b50787d');
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cDXGHXXf4S', 0, '-nWiDvWc2Iymt1-rNNaTuw', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'validator.mapping.cache.prefix' => 'validator_f37371797b98460e108a8bcc57649b7cae3d9e639e590d057cbac620253c72f8',
...
class DoctrineORMEntityManager_0000000036e295520000000070d20233192495198c3a374831398440c7902962 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder58131e9854932689820124 = null;
    private $initializer58131e985494b686281649 = null;
    private static $publicProperties58131e98548f8575513757 = array(
        
    );
    public function getConnection()
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'getConnection', array(), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->getConnection();
    }
    public function getMetadataFactory()
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'getMetadataFactory', array(), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->getMetadataFactory();
    }
    public function getExpressionBuilder()
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'getExpressionBuilder', array(), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->getExpressionBuilder();
    }
    public function beginTransaction()
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'beginTransaction', array(), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->beginTransaction();
    }
    public function getCache()
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'getCache', array(), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->getCache();
    }
    public function transactional($func)
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'transactional', array('func' => $func), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->transactional($func);
    }
    public function commit()
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'commit', array(), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->commit();
    }
    public function rollback()
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'rollback', array(), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->rollback();
    }
    public function getClassMetadata($className)
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'getClassMetadata', array('className' => $className), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->getClassMetadata($className);
    }
    public function createQuery($dql = '')
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'createQuery', array('dql' => $dql), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->createQuery($dql);
    }
    public function createNamedQuery($name)
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'createNamedQuery', array('name' => $name), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->createNamedQuery($name);
    }
    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->createNativeQuery($sql, $rsm);
    }
    public function createNamedNativeQuery($name)
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->createNamedNativeQuery($name);
    }
    public function createQueryBuilder()
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'createQueryBuilder', array(), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->createQueryBuilder();
    }
    public function flush($entity = null)
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'flush', array('entity' => $entity), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->flush($entity);
    }
    public function find($entityName, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'find', array('entityName' => $entityName, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->find($entityName, $id, $lockMode, $lockVersion);
    }
    public function getReference($entityName, $id)
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->getReference($entityName, $id);
    }
    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->getPartialReference($entityName, $identifier);
    }
    public function clear($entityName = null)
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'clear', array('entityName' => $entityName), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->clear($entityName);
    }
    public function close()
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'close', array(), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->close();
    }
    public function persist($entity)
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'persist', array('entity' => $entity), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->persist($entity);
    }
    public function remove($entity)
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'remove', array('entity' => $entity), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->remove($entity);
    }
    public function refresh($entity)
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'refresh', array('entity' => $entity), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->refresh($entity);
    }
    public function detach($entity)
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'detach', array('entity' => $entity), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->detach($entity);
    }
    public function merge($entity)
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'merge', array('entity' => $entity), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->merge($entity);
    }
    public function copy($entity, $deep = false)
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->copy($entity, $deep);
    }
    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->lock($entity, $lockMode, $lockVersion);
    }
    public function getRepository($entityName)
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'getRepository', array('entityName' => $entityName), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->getRepository($entityName);
    }
    public function contains($entity)
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'contains', array('entity' => $entity), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->contains($entity);
    }
    public function getEventManager()
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'getEventManager', array(), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->getEventManager();
    }
    public function getConfiguration()
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'getConfiguration', array(), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->getConfiguration();
    }
    public function isOpen()
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'isOpen', array(), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->isOpen();
    }
    public function getUnitOfWork()
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'getUnitOfWork', array(), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->getUnitOfWork();
    }
    public function getHydrator($hydrationMode)
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->getHydrator($hydrationMode);
    }
    public function newHydrator($hydrationMode)
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->newHydrator($hydrationMode);
    }
    public function getProxyFactory()
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'getProxyFactory', array(), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->getProxyFactory();
    }
    public function initializeObject($obj)
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'initializeObject', array('obj' => $obj), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->initializeObject($obj);
    }
    public function getFilters()
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'getFilters', array(), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->getFilters();
    }
    public function isFiltersStateClean()
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'isFiltersStateClean', array(), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->isFiltersStateClean();
    }
    public function hasFilters()
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'hasFilters', array(), $this->initializer58131e985494b686281649);
        return $this->valueHolder58131e9854932689820124->hasFilters();
    }
    public function __construct($initializer)
    {
        $this->initializer58131e985494b686281649 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, '__get', array('name' => $name), $this->initializer58131e985494b686281649);
        if (isset(self::$publicProperties58131e98548f8575513757[$name])) {
            return $this->valueHolder58131e9854932689820124->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58131e9854932689820124;
    ...
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer58131e985494b686281649);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58131e9854932689820124;
    ...
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, '__isset', array('name' => $name), $this->initializer58131e985494b686281649);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58131e9854932689820124;
    ...
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, '__unset', array('name' => $name), $this->initializer58131e985494b686281649);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58131e9854932689820124;
    ...
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, '__clone', array(), $this->initializer58131e985494b686281649);
        $this->valueHolder58131e9854932689820124 = clone $this->valueHolder58131e9854932689820124;
    }
    public function __sleep()
    {
        $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, '__sleep', array(), $this->initializer58131e985494b686281649);
        return array('valueHolder58131e9854932689820124');
    }
    ...
    {
        return $this->initializer58131e985494b686281649;
    }
    public function initializeProxy()
    {
        return $this->initializer58131e985494b686281649 && $this->initializer58131e985494b686281649->__invoke($this->valueHolder58131e9854932689820124, $this, 'initializeProxy', array(), $this->initializer58131e985494b686281649);
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder58131e9854932689820124;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder58131e9854932689820124;
    }
}
